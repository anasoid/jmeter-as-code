...
class GraphVisualizerWrapperXmlTest extends AbstractJmcCoreTest {
  ...
  void testSetter()
    ...
    SetterTestUtils.testSetter(GraphVisualizerWrapper.builder());
  }

  @Test
  void testDefault() throws IOException {
    TestPlanWrapper testPlanWrapper =
        TestPlanWrapper.builder().addListener(GraphVisualizerWrapper.builder().build()).build();

    checkWrapper(testPlanWrapper, PARENT_PATH + "/graphResults.default.jmx", NODE_NAME);
  }
}
