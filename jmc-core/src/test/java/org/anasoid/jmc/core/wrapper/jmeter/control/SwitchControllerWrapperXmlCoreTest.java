...
class SwitchControllerWrapperXmlCoreTest extends AbstractJmcCoreTest {
  ...
  void testSetter()
    ...
    SetterTestUtils.testSetter(SwitchControllerWrapper.builder());
  }
  ...
  void testDefault() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/switchController.default.jmx", NODE_NAME);
  }
  ...
  void testInverse() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/switchController.inverse.jmx", NODE_NAME);
  }
}
