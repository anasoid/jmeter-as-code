...
class SimplePageTemplateTest extends AbstractJmcCoreTest {
  ...
  void testParam() {
    ...
    JmcTemplate<HTTPSamplerProxyWrapper> simplePageTemplate =
        new SimplePageTemplate(NAME, PATH, DOMAIN, HttpMethod.POST);
    HTTPSamplerProxyWrapper sampler = simplePageTemplate.generate();
  ...
  void testMinParam() {
    ...
    JmcTemplate<HTTPSamplerProxyWrapper> simplePageTemplate = new SimplePageTemplate(NAME, PATH);
    HTTPSamplerProxyWrapper sampler = simplePageTemplate.generate();
    Assertions.assertEquals(NAME, sampler.getName());
    Assertions.assertEquals(PATH, sampler.getPath());
  ...
  void testThreeParam() {
    ...
    JmcTemplate<HTTPSamplerProxyWrapper> simplePageTemplate =
        new SimplePageTemplate(NAME, PATH, DOMAIN);
    HTTPSamplerProxyWrapper sampler = simplePageTemplate.generate();
    Assertions.assertEquals(NAME, sampler.getName());
    Assertions.assertEquals(PATH, sampler.getPath());
    Assertions.assertEquals(DOMAIN, sampler.getDomain());
