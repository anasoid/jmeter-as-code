...
class WhileControllerWrapperXmlCoreTest extends AbstractJmcCoreTest {
  ...
  void testSetter()
    ...
    SetterTestUtils.testSetter(WhileControllerWrapper.builder());
  }
  ...
  void testDefault() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/whileController.default.jmx", NODE_NAME);
  }
  ...
  void testInverse() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/whileController.inverse.jmx", NODE_NAME);
  }
}
