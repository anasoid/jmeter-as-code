...
class DebugSamplerWrapperXmlCoreTest extends AbstractJmcCoreTest {
  ...
  void testSetter()
    ...
    SetterTestUtils.testSetter(DebugSamplerWrapper.builder());
  }
  ...
  void testDefault() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/debugSampler.default.jmx", NODE_NAME);
  }
  ...
  void testDefaultInverse() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/debugSampler.inverse.jmx", NODE_NAME);
  }
}
