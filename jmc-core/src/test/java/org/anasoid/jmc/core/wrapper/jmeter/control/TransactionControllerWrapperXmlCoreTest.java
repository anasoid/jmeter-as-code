...
class TransactionControllerWrapperXmlCoreTest extends AbstractJmcCoreTest {
  ...
  void testSetter()
    ...
    SetterTestUtils.testSetter(TransactionControllerWrapper.builder());
  }
  ...
  void testDefault() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/transactionController.default.jmx", NODE_NAME);
  }
  ...
  void testInverse() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/transactionController.inverse.jmx", NODE_NAME);
  }
}
