...
class IfControllerWrapperXmlCoreTest extends AbstractJmcCoreTest {
  ...
  void testSetter()
    ...
    SetterTestUtils.testSetter(IfControllerWrapper.builder());
  }
  ...
  void testDefault() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/ifController.default.jmx", NODE_NAME);
  }
  ...
  void testInverse() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/ifController.inverse.jmx", NODE_NAME);
  }
}
