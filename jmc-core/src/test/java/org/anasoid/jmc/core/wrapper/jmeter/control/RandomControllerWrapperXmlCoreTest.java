...
class RandomControllerWrapperXmlCoreTest extends AbstractJmcCoreTest {
  ...
  void testSetter()
    ...
    SetterTestUtils.testSetter(RandomControllerWrapper.builder());
  }
  ...
  void testDefault() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/randomController.default.jmx", NODE_NAME);
  }
  ...
  void testInverse() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/randomController.inverse.jmx", NODE_NAME);
  }
}
