...
/** SampleListener Include Jmx. */
@SuperBuilder(setterPrefix = "with", toBuilder = true)
public class ListenerJmxIncludeWrapper extends AbstractJmxIncludeWrapper<SampleListener>
    implements SampleListenerWrapper<SampleListener> {}
