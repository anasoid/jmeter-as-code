...
class ArrivalsThreadGroupWrapperXmlTest extends AbstractJmcJmeterPluginTest {
  ...
  void testSetter()
    ...
    SetterTestUtils.testSetter(ArrivalsThreadGroupWrapper.builder());
  }
  ...
  void testDefault() throws IOException {
    ...
    TestPlanWrapper testPlanWrapper =
        TestPlanWrapper.builder()
            .addThread(
                ArrivalsThreadGroupWrapper.builder().withHold(1).withTargetConcurrency(1).build())
            .build();

    checkWrapper(testPlanWrapper, PARENT_PATH + "/bzmArrivalsThreadGroup.default.jmx", NODE_NAME);
  }
  ...
  void testInverse() throws IOException {
    ...
    TestPlanWrapper testPlanWrapper =
        TestPlanWrapper.builder()
            .addThread(
                ArrivalsThreadGroupWrapper.builder()
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/bzmArrivalsThreadGroup.inverse.jmx", NODE_NAME);
  }
}
