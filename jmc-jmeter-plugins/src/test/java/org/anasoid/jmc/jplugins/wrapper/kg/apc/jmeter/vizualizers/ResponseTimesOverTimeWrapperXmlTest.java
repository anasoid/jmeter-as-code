...
class ResponseTimesOverTimeWrapperXmlTest extends AbstractJmcJmeterPluginTest {
  ...
  void testDefault() throws IOException {
    ...
    TestPlanWrapper testPlanWrapper =
        TestPlanWrapper.builder()
            .addListener(ResponseTimesOverTimeWrapper.builder().build())
            .build();

    checkWrapper(testPlanWrapper, PARENT_PATH + "/ResponseTimesOverTime.default.jmx", NODE_NAME);
  }
  ...
  void testInverse() throws IOException {
    ...
    TestPlanWrapper testPlanWrapper =
        TestPlanWrapper.builder()
            .addListener(
                ResponseTimesOverTimeWrapper.builder()
                    .withStartOffset(10)
                    .withEndOffset(20)
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/ResponseTimesOverTime.inverse.jmx", NODE_NAME);
  }
}
