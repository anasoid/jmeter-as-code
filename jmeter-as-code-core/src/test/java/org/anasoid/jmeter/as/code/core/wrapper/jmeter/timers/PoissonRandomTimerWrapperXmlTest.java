...
class PoissonRandomTimerWrapperXmlTest extends AbstractJmcTest {

  private static final String PARENT_PATH = "org/anasoid/jmeter/as/code/core/wrapper/jmeter/timers";

  private static final String NODE_NAME = "PoissonRandomTimer";

  @Test
  void testSetter()
      throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
    SetterTestUtils.testSetter(PoissonRandomTimerWrapper.builder());
  }
  ...
  void testVar() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/poissonRandomTimer.var.jmx", NODE_NAME);
  }
}
