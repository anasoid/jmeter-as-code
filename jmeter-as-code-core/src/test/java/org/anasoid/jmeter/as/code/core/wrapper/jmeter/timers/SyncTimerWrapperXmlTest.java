...
class SyncTimerWrapperXmlTest extends AbstractJmcTest {

  private static final String PARENT_PATH = "org/anasoid/jmeter/as/code/core/wrapper/jmeter/timers";

  private static final String NODE_NAME = "SyncTimer";

  @Test
  void testSetter()
      throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
    SetterTestUtils.testSetter(SyncTimerWrapper.builder());
  }
  ...
  void testVar() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/synchronizingTimer.var.jmx", NODE_NAME);
  }
}
