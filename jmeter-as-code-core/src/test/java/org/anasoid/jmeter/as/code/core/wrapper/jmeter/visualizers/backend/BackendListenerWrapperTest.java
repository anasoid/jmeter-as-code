package org.anasoid.jmeter.as.code.core.wrapper.jmeter.visualizers.backend;
...
class BackendListenerWrapperTest extends AbstractJmcTest {

  @Test
  void testSetter()
      throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
    SetterTestUtils.testSetter(BackendListenerWrapper.builder());
  }
