...
import org.anasoid.jmeter.as.code.core.wrapper.jmeter.assertions.SizeAssertionWrapper.FieldtoTest;
import org.anasoid.jmeter.as.code.core.wrapper.jmeter.assertions.SizeAssertionWrapper.Operator;
...
class SizeAssertionWrapperXmlTest extends AbstractJmcTest {
  ...
  void testSetter()
    ...
    SetterTestUtils.testSetter(SizeAssertionWrapper.builder().build());
  }
