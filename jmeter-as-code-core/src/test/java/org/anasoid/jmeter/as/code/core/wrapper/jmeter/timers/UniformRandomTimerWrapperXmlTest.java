...
class UniformRandomTimerWrapperXmlTest extends AbstractJmcTest {

  private static final String PARENT_PATH = "org/anasoid/jmeter/as/code/core/wrapper/jmeter/timers";

  private static final String NODE_NAME = "UniformRandomTimer";

  @Test
  void testSetter()
      throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
    SetterTestUtils.testSetter(UniformRandomTimerWrapper.builder());
  }
  ...
  void testVar() throws IOException {
    ...
    checkWrapper(testPlanWrapper, PARENT_PATH + "/uniformRandomTimer.var.jmx", NODE_NAME);
  }
}
