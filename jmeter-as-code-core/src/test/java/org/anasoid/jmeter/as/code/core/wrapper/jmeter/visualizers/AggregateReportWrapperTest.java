...
import org.anasoid.jmeter.as.code.core.wrapper.jmeter.assertions.jmespath.JMESPathAssertionWrapper;
...
class AggregateReportWrapperTest extends AbstractJmcTest {

  @Test
  void testSetter()
      throws NoSuchMethodException, IllegalAccessException, InvocationTargetException {
    SetterTestUtils.testSetter(AggregateReportWrapper.builder());
  }
