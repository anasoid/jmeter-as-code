...
import org.anasoid.jmc.plugins.wrapper.java.timers.executor.TestJavaTimerWrapper;
...
class AbstractJavaTimerWrapperTest extends AbstractJmcPluginJavaTest {
  private static final Logger LOG = LoggerFactory.getLogger(AbstractJavaTimerWrapperTest.class);
        ...
        TestPlanWrapper.builder()
            .addThread(
                ThreadGroupWrapper.builder()
                    ...
                    .build())
            .addTimer(TestJavaTimerWrapper.builder().withName("testDefault").build())
            .build();
        ...
        TestPlanWrapper.builder()
            .addThread(
                ThreadGroupWrapper.builder()
                    ...
                    .addSampler(DebugSamplerWrapper.builder().build())
                    .build())
            .addTimer(TestJavaTimerWrapperWithField.builder().withName("testWithField").build())
            .build();
    ApplicationTest applicationTest = toApplicationTest(testPlanWrapper, "javaPost");
    applicationTest.run();
    Assertions.assertEquals(
        ...
        TestPlanWrapper.builder()
            .addThread(
                ThreadGroupWrapper.builder()
                    ...
                    .build())
            .addTimer(
                TestJavaTimerWrapperWithField.builder()
                    .withIncrement(100)
  ...
  void testFilterProperties() throws IOException {
    ...
    JavaTimer javaTimer =
        (JavaTimer) applicationTest.get(applicationTest.getArray()[0]).getArray()[0];
    Arguments arguments = ExecutorUtils.extractAttributeArguments(javaTimer);
