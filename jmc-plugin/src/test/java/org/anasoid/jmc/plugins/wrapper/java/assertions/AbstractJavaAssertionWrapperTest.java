package org.anasoid.jmc.plugins.wrapper.java.assertions;
...
import org.anasoid.jmc.plugins.component.java.assertions.JavaAssertion;
import org.anasoid.jmc.plugins.utils.ExecutorUtils;
import org.anasoid.jmc.plugins.wrapper.java.AbstractJmcPluginJavaTest;
import org.anasoid.jmc.plugins.wrapper.java.assertions.executor.TestJavaAssertionWrapper;
import org.anasoid.jmc.plugins.wrapper.java.assertions.executor.TestJavaAssertionWrapperWithField;
...
class AbstractJavaAssertionWrapperTest extends AbstractJmcPluginJavaTest {
  private static final Logger LOG = LoggerFactory.getLogger(AbstractJavaAssertionWrapperTest.class);
        ...
        TestPlanWrapper.builder()
            .addThread(
                ThreadGroupWrapper.builder()
                    ...
                    .build())
            .addAssertion(TestJavaAssertionWrapper.builder().withName("testDefault").build())
            .build();
        ...
        TestPlanWrapper.builder()
            .addThread(
                ThreadGroupWrapper.builder()
                    ...
                    .build())
            .addAssertion(
                TestJavaAssertionWrapperWithField.builder().withName("testWithField").build())
            .build();
    ApplicationTest applicationTest = toApplicationTest(testPlanWrapper, "javaPost");
    applicationTest.run();
    Assertions.assertEquals(
        ...
        TestPlanWrapper.builder()
            .addThread(
                ThreadGroupWrapper.builder()
                    ...
                    .build())
            .addAssertion(
                TestJavaAssertionWrapperWithField.builder()
                    .withIncrement(100)
  ...
  void testFilterProperties() throws IOException {
    ...
    JavaAssertion javaAssertion =
        (JavaAssertion) applicationTest.get(applicationTest.getArray()[0]).getArray()[0];
    Arguments arguments = ExecutorUtils.extractAttributeArguments(javaAssertion);
