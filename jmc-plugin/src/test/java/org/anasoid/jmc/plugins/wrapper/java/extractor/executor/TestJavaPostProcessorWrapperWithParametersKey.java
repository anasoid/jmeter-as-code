...
public class TestJavaPostProcessorWrapperWithParametersKey
    extends AbstractJavaPostProcessorWrapper {
  ...
  public void execute(
    ...
    log.info("TestJavaPostProcessorWrapperWithParametersKey : #########ME###############");
