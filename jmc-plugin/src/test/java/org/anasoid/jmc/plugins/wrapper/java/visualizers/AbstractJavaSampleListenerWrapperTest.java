package org.anasoid.jmc.plugins.wrapper.java.visualizers;
...
import org.anasoid.jmc.plugins.component.java.visualizers.JavaSampleListener;
import org.anasoid.jmc.plugins.utils.ExecutorUtils;
import org.anasoid.jmc.plugins.wrapper.java.AbstractJmcPluginJavaTest;
import org.anasoid.jmc.plugins.wrapper.java.visualizers.executor.TestJavaSampleListenerWrapper;
import org.anasoid.jmc.plugins.wrapper.java.visualizers.executor.TestJavaSampleListenerWrapperWithField;
...
class AbstractJavaSampleListenerWrapperTest extends AbstractJmcPluginJavaTest {
  private static final Logger LOG =
      LoggerFactory.getLogger(AbstractJavaSampleListenerWrapperTest.class);
        ...
        TestPlanWrapper.builder()
            .addThread(
                ThreadGroupWrapper.builder()
                    ...
                    .build())
            .addListener(TestJavaSampleListenerWrapper.builder().withName("testDefault").build())
            .build();
        ...
        TestPlanWrapper.builder()
            .addThread(
                ThreadGroupWrapper.builder()
                    ...
                    .build())
            .addListener(
                TestJavaSampleListenerWrapperWithField.builder().withName("testWithField").build())
            .build();
    ApplicationTest applicationTest = toApplicationTest(testPlanWrapper, "javaPost");
    applicationTest.run();
    Assertions.assertEquals(
        ...
        TestPlanWrapper.builder()
            .addThread(
                ThreadGroupWrapper.builder()
                    ...
                    .build())
            .addListener(
                TestJavaSampleListenerWrapperWithField.builder()
                    .withIncrement(100)
  ...
  void testFilterProperties() throws IOException {
    ...
    JavaSampleListener javaSampleListener =
        (JavaSampleListener) applicationTest.get(applicationTest.getArray()[0]).getArray()[0];
    Arguments arguments = ExecutorUtils.extractAttributeArguments(javaSampleListener);
